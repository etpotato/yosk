  ...
  {:else}
    <svg viewBox="0 0 24 24" fill="none" class="mic">
      ...
      <path
        ...
        stroke-linecap="round"
      />
      <path d="M12 18L12 21" stroke="#EE4B2B" stroke-width="2" stroke-linecap="round" />
      <path
        d="M3 3L21 21"
        stroke="#EE4B2B"
        stroke-width="2"
